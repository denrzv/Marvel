...
function getCharacterCards(characters) {
    ...
    for(let i = 0; i < characters.length; i++) {
        ...
        let characterCard = getCharacterCard(character);
        charactersCards.push(characterCard);
    }
...
function getCharacterModals(characters) {
    let charactersModals = [];

        for(let i = 0; i < characters.length; i++) {
            let character = characters[i];
            let characterModal = getCharacterModal(character);
            charactersModals.push(characterModal);
        }

        return charactersModals;
}
